...
describe('react-jss', function () {
  ...
  describe('.create()', function () {
    ...
    it('should use passed jss', function () {
      ...
      var Component = localInjectSheet()(WrappedComponent);
  ...
  describe('.injectSheet() classes prop', function () {
    ...
    beforeEach(function () {
      var WrappedComponent = function WrappedComponent(_ref2) {
  ...
  describe('dynamic sheets', function () {
    var Component = void 0;
    var color = 'rgb(0, 0, 0)';

    beforeEach(function () {
      // eslint-disable-next-line react/prop-types
      var WrappedComponent = function WrappedComponent(_ref3) {
        var classes = _ref3.classes;
        return _react2['default'].createElement('div', { className: classes.button });
      };
